...
<body>	
	<table>
		<tr>
			<td colspan="2" style="text-align: center;	height: 30px; line-height: 30px">
			<h3>회원 등록 완료</h3>
			아래와 같이 회원 등록이 완료 되었습니다.<br/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="content">${ sessionScope.member.gender == null ? "입력안됨" : sessionScope.member.gender }</td>
		</tr>
		<tr>
