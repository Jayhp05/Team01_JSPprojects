...
@WebServlet("/today") // 서블렛은 매핑을 이용해 실행이 된다.
public class TodayServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, 
		...
		out.print("\n");
		out.print(" 		현재 시간은 " + today.get(Calendar.HOUR) + "시 ");
		out.print(			today.get(Calendar.MINUTE) + "분 ");
		out.print(			today.get(Calendar.SECOND) + "초 입니다.");
		out.println("	</body>");
		out.println("<html>");
